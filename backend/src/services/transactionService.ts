import { PrismaClient, Transaction as PrismaTransaction, Prisma, TransactionType } from '@prisma/client';
import { Transaction } from '../types/transaction';

const prisma = new PrismaClient();

const mapToTransaction = (data: PrismaTransaction & { tags?: any[] }): Transaction => {
  return {
    id: data.id,
    date: data.date,
